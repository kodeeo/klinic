    ...
    <form action="{{route('insurance.store')}}" method="post">
        ...
        <div class="row">
            ...
            <div class="form-group col-6">
                ...
                <input name="discount" type="integer" class="form-control" id="discount" placeholder="Discount" value="">
            </div>
            ...
            <div class="form-group">
                <div data-role="dynamic-fields">
                    <div class="form-inline">
                        <div class="row">
                            <div class="col-4">
                                <input name="disease_name" type="string" class="form-control" placeholder="Disease Name" value="">
                            </div>
                            <div class="col-4">
                                <input name="disease_charge" type="integer" class="form-control" placeholder="Disease Charge" value="">
                            </div>
                            <div class="col-4">
                                <div class="btn-group">
            ...
            <div class="form-group col-6">
                ...
                <input name="total" type="integer" class="form-control" id="total" placeholder="Total" value="">
            </div>
