...
<div class="panel panel-default thumbnail">
    ...
    <div class="panel-heading no-print">
        <div class="btn-group">
            <a class="btn btn-primary" href="https://hospitalnew.bdtask.com/demo7/insurance/insurance"> <i
                    class="fa fa-list" style="font-family: FontAwesome, Bangla871, sans-serif;"></i> Insurance List </a>
        </div>
    </div>
    <form>
        <div class="row">
