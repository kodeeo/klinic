        ...
        <form action="{{ route('prescription.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-8">
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="number" min="1" class="form-control" id="blood_pressure"
                                name="blood_pressure" placeholder="Enter Blood Pressure">
                        </div>
                        <div class="form-group col-6">
                        ...
                        <div class="form-group col-6 mt-2">
                            ...
                            <select class="form-select" name="insurance_id" id="insurance"
            ...
            <div class="container" style="padding-left:25%; padding-right:25%">
                <div class="form-group mt-2" style="display: block ruby">
                    ...
                    <input type="number" min="1" class="form-control" id="fees" name="fees"
                        placeholder="Enter Visiting Fee">
                </div>

                <div class="form-group mt-2" style="display: block ruby">
                    <label for="patient_notes">Patient Notes</label>
                    <textarea type="text" class="form-control" id="patient_note" name="patient_note" placeholder="Enter Note"></textarea>
                </div>
            </div>
