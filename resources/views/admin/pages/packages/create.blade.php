        ...
        <form action="{{ route('packages.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="name">Package Name <span
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        var fieldHTML =
                            '<div class="service row d-flex"><div class="col-sm-2"></div><div class="col-3"><select id="services" name="service_name[]" class="form-control"> @foreach ($services as $item)<option value="{{ $item->name }}">{{ $item->name }}</option> @endforeach</select></div><div class="col-2"><input type="number" name="service_quantity[]" class="form-control" placeholder="Enter Quantity" value=""/></div><div class="col-2"><input type="number" name="service_rate[]" class="form-control" placeholder="Enter Rate" value=""/></div><div class="col-3"><a href="javascript:void(0);" class="remove_button btn btn-danger">Remove</a></div><hr class="row" style="height:1px; margin-left:0.5rem; margin-top: 1rem;"></div>'; //New input field html
