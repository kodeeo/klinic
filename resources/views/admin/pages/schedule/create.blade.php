        ...
        <form action="{{ route('schedule.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="text" class="timepicker form-control" id="patient_time" name="patient_time"
                        placeholder="Enter Patient Time">
                    <div class="alert-danger">
                        {{ $errors->first('patient_time') }}
                    </div>
                </div>
