...
<div class="row" style="justify-content: space-between;">
  <div class="col">
  <a class="d-print-none btn btn-success" href="{{route('operational_activities.create')}}">Create Operation Report</a>
  </div>

  <div class="col-4 dt-buttons btn-group">
      <a class="d-print-none btn btn-info" href="{{route('operational.report.csv')}}">
        CSV
      </a>
      <a class="d-print-none btn btn-info" href="{{route('operational.report.excel')}}">
        Excel
      </a>
